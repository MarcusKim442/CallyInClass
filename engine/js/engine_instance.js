...
class EngineInstance {
	 ...
	 * onCreate():
	 *
	 * IMPORTANT: This method is only run automatically when the engine DOES NOT create this instance via a room.
	 *
	...
	constructor(...args) {
		...
		if (args[0] === $engine.__instanceCreationSpecial) {
			...
			// calls on create of this EngineInstance inst with args
	 ...
	 * @throws {Error} If the instance does not currently have a sprite.
...
EngineInstance.do = function (func, other) {
	IM.with(this, func, other);
};

Object.defineProperty(EngineInstance, "first", {
	get: function () {
		return IM.find(this);
	},
});

Object.defineProperty(EngineInstance, "all", {
	get: function () {
		return IM.findAll(this);
	},
});

Object.defineProperty(EngineInstance.prototype, "x", {
	set: function (x) {
		const old = this._x;
		this._x = x;
		if (old !== x) {
...
Object.defineProperty(EngineInstance.prototype, "y", {
	set: function (y) {
		const old = this._y;
		this._y = y;
		if (old !== y) {
...
Object.defineProperty(EngineInstance.prototype, "xScale", {
	set: function (xScale) {
...
Object.defineProperty(EngineInstance.prototype, "yScale", {
	set: function (yScale) {
...
Object.defineProperty(EngineInstance.prototype, "angle", {
	set: function (angle) {
